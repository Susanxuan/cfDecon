...
def plot_scatter_plots(beta_est, beta_truth, r1, input_path, simi, mode, file):
    ...
    fig.savefig('./results/figure/celfeer' + input_path + str(simi) + mode + file + '.png')
    #plt.show()


def main():
    for r1 in [[0]]:  # [0], [128, 72, 48, 12], [128, 64, 12]
        ...
        for file in ["0.1False0.4", "0.3False0.4", "0.5False0.4", "0.3True0.1", "0.3True0.2", "0.3True0.3"]:
            ...
            print(file)
            print("r1", r1, "\n")
            #beta_truth_path = './results/' + input_path + str(simi) + mode + file + str(r1) + 'beta_true_2.pkl'
            beta_truth_path = './results/celfeer' + input_path + str(simi) + mode + file + 'beta_true.pkl'
            ...
            beta_est_path = './results/celfeer' + input_path + str(simi) + mode + file + 'beta_est.pkl'
